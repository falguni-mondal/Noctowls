...
const Catalog = () => {
  ...
  return (
    <div className='catalog-page py-10'>
      ...
      <div className="catalog-products grid grid-cols-2 gap-x-3 gap-y-10 mt-8 px-3">
        {
          products.map(product => (
            <Link to={`/products/${product.id}`}>
              <ProductListItem key={`${product.id}-catalog-listing-key`} product={product} />
            </Link>
          ))
        }
      </div>
