    ...
    <div className='px-3 py-10' id="admin-product-page">
      ...
      <div className="admin-product-btns w-10 fixed bottom-18 right-3">
        <div className="add-product-btn w-full aspect-square rounded mb-2">
          <Link className="w-full h-full flex justify-center items-center bg-blue-900 text-base rounded" to="/admin/reviews">
            <Icon icon="material-symbols-light:inbox-text-asterisk" />
          </Link>
        </div>
        <div className="add-product-btn w-full aspect-square rounded mb-2">
          <Link className="w-full h-full flex justify-center items-center bg-green-900 text-base rounded" to="/admin/coupons">
            <Icon icon="hugeicons:coupon-01" />
          </Link>
        </div>
        <div className="add-product-btn w-full aspect-square rounded">
          <Link className="w-full h-full flex justify-center items-center bg-indigo-900 text-base rounded" to="/admin/products/add">
