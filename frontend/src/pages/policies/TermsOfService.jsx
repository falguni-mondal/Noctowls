...
const TermsOfService = () => {
  ...
  return (
    <PolicyLayout title="Terms of Service">
      {/* Introduction */}
      <div className="mb-12 space-y-6 text-sm md:text-base text-zinc-600 leading-relaxed">
        <div className="border-y border-r border-zinc-200 border-l-4 border-l-red-600 pl-6 py-4 pr-4 bg-white rounded-r-xl shadow-sm">
          <h3 className="text-[#0f0f0f] font-bold uppercase tracking-wider mb-2">Agreement to Our Legal Terms</h3>
          <p className="text-zinc-600">
            We are <strong className="text-[#0f0f0f]">Noctowls</strong> ('Company', 'we', 'us', or 'our'). We operate the website <span className="text-[#0f0f0f] font-bold">https://www.noctowls.com</span> (the 'Site'), as well as any other related products and services that refer or link to these legal terms (the 'Legal Terms') (collectively, the 'Services').
          </p>
        </div>
        ...
        <p>
          You can contact us by phone at <strong className="text-[#0f0f0f]">+918348341112</strong>, email at <a href="mailto:help.noctowls@gmail.com" className="text-red-600 font-bold hover:underline">help.noctowls@gmail.com</a>, or by mail to <strong className="text-[#0f0f0f]">2nd floor, Arushi complex, ITI Aambagan, Muchipara, Durgapur, West Bengal 713212, India</strong>.
        </p>

        <p>
          These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('you'), and Noctowls, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong className="text-[#0f0f0f]">IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
        </p>

        <div className="bg-zinc-50 p-5 rounded-xl border border-zinc-200 text-xs text-zinc-500 shadow-sm font-medium">
      ...
      {/* Table of Contents */}
      <div className="bg-white border border-zinc-200 p-6 md:p-8 rounded-xl mb-16 shadow-sm">
        <h3 className="text-[#0f0f0f] font-bold uppercase tracking-widest text-xs mb-6 border-b border-zinc-200 pb-3">Table of Contents</h3>
        <div className="grid md:grid-cols-2 gap-x-8 gap-y-3 text-sm">
          {tocItems.map((item, index) => (
            <a 
              key={index} 
              href={`#section-${index + 1}`} 
              className="flex items-start gap-3 hover:text-red-600 transition-colors group font-medium text-zinc-600"
            >
              <span className="text-zinc-400 font-mono text-xs pt-0.5 group-hover:text-red-600 font-bold">{String(index + 1).padStart(2, '0')}</span>
              <span>{item}</span>
            </a>
          ))}
        </div>
      ...
      <div className="space-y-16 text-zinc-600 leading-relaxed">
        ...
        <section id="section-1">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">1. Our Services</h2>
          <p>The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.</p>
        </section>

        {/* 2. IP Rights */}
        <section id="section-2">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">2. Intellectual Property Rights</h2>
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2">Our intellectual property</h3>
          ...
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2 mt-6">Your use of our Services</h3>
          ...
          <p className="mb-4">If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:help.noctowls@gmail.com" className="text-red-600 font-bold hover:underline">help.noctowls@gmail.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part or our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
          ...
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2 mt-6">Your submissions and contributions</h3>
          ...
          <p className="mb-4"><strong className="text-[#0f0f0f]">Submissions:</strong> By directly sending us any question, comment, suggestion, Idea, Feedback, or other Information about the Services ('Submissions'), you agree to assign to us all intellectual property rights in such Submission. You agree that we shall own this Submission and be entitled to its unrestricted use and dissemination for any lawful purpose, commercial or otherwise, without acknowledgment or compensation to you.</p>
          
          <p className="mb-4"><strong className="text-[#0f0f0f]">Contributions:</strong> The Services may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality during which you may create, submit, post, display, transmit, publish, distribute, or broadcast content and materials to us or through the Services, including but not limited to text, writings, video, audio, photographs, music, graphics, comments, reviews, rating suggestions, personal information, or other material ('Contributions'). Any Submission that is publicly posted shall also be treated as a contribution. You understand that contributions may be viewable by other users of the Services and possibly through third-party websites.</p>
          
          <p className="mb-4"><strong className="text-[#0f0f0f]">When you post Contributions, you grant us a licence (including use of your name, trademarks, and logos):</strong> By posting any Contributions, you grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and licence to: use, copy, reproduce, distribute, sell, resell, publish, broadcast, retitle, store, publicly perform, publicly display, reformat, translate, excerpt (in whole or in part), and exploit your Contributions (including, without limitation, your Image, name, and voice) for any purpose, commercial, advertising, or otherwise, to prepare derivative works with, or Incorporate Into other works, your contributions, and to sublicense the licences granted in this section. Our use and distribution may be in any media formats and through any media channels. This license includes our use of your name, company name, and franchise name, as applicable, and any of the trademarks, service marks, trade names, logos, and personal and commercial images you provide.</p>
          
          <p className="mb-2"><strong className="text-[#0f0f0f]">You are responsible for what you post or upload:</strong> By sending us Submissions and/or posting Contributions through any part of the Services or making Contributions accessible through the Services by linking your account through the Services to any of your social networking accounts, you:</p>
        ...
        <section id="section-3">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">3. User Representations</h2>
        ...
        <section id="section-4">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">4. User Registration</h2>
        ...
        <section id="section-5">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">5. Products</h2>
        ...
        <section id="section-6">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">6. Purchases and Payment</h2>
        ...
        <section id="section-7">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">7. Return Policy</h2>
          <p>Please review our Return Policy prior to making any purchases: <Link to="/policies/refund-policy" className="text-red-600 font-bold hover:underline">Return Policy</Link>.</p>
        </section>

        {/* 8. Prohibited Activities */}
        <section id="section-8">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">8. Prohibited Activities</h2>
        ...
        <section id="section-9">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">9. User-Generated Contributions</h2>
        ...
        <section id="section-10">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">10. Contribution Licence</h2>
        ...
        <section id="section-11">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">11. Guidelines for Reviews</h2>
        ...
        <section id="section-12">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">12. Social Media</h2>
        ...
        <section id="section-13">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">13. Third-Party Websites and Content</h2>
        ...
        <section id="section-14">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">14. Services Management</h2>
        ...
        <section id="section-15">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">15. Privacy Policy</h2>
          <p>We care about data privacy and security. Please review our Privacy Policy: <Link to="/policies/privacy-policy" className="text-red-600 font-bold hover:underline">Privacy Policy</Link>. By using the Services, you agree to be bound by our Privacy Policy, which is Incorporated Into these Legal Terms. Please be advised that the Services are hosted in India. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in India, then through your continued use of the Services, you are transferring your data to India, and you expressly consent to have your data transferred to and processed in India.</p>
        </section>

        {/* 16. Copyright Infringements */}
        <section id="section-16">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">16. Copyright Infringements</h2>
        ...
        <section id="section-17">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">17. Term and Termination</h2>
        ...
        <section id="section-18">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">18. Modification and Interruptions</h2>
        ...
        <section id="section-19">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">19. Governing Law</h2>
        ...
        <section id="section-20">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">20. Dispute Resolution</h2>
          
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2">Informal Negotiations</h3>
          ...
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2">Binding Arbitration</h3>
          ...
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2">Restrictions</h3>
          <p className="mb-4">The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilise class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.</p>
          
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2">Exceptions to Informal Negotiations and Arbitration</h3>
        ...
        <section id="section-21">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">21. Corrections</h2>
          <p>There may be information on the Services that contains typographical errors, Inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the Information on the Services at any time, without prior notice.</p>
        </section>

        {/* 22. Disclaimer */}
        <section id="section-22">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">22. Disclaimer</h2>
          <div className="p-6 md:p-8 bg-zinc-50 border border-zinc-200 rounded-xl text-sm text-zinc-600 leading-relaxed uppercase shadow-sm">
        ...
        <section id="section-24">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">24. Indemnification</h2>
        ...
        <section id="section-25">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">25. User Data</h2>
        ...
        <section id="section-26">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">26. Electronic Communications, Transactions and Signatures</h2>
          ...
          <p className="uppercase font-bold text-[#0f0f0f]">YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES, CONTRACTS, ORDERS, AND OTHER RECORDS, AND TO ELECTRONIC DELIVERY OF NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE SERVICES.</p>
        ...
        <section id="section-27">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">27. SMS Text Messaging</h2>
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2">Program Description</h3>
          ...
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2">Message Frequency</h3>
          ...
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2">Opting Out</h3>
          ...
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2">Message and Data Rates</h3>
          ...
          <h3 className="text-lg font-bold text-[#0f0f0f] mb-2">Support</h3>
          <p>If you have any questions or need assistance regarding our SMS communications, please email us at <a href="mailto:help.noctowls@gmail.com" className="text-red-600 font-bold hover:underline">help.noctowls@gmail.com</a> or call +918348341112.</p>
        </section>

        {/* 28. Miscellaneous */}
        <section id="section-28">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">28. Miscellaneous</h2>
        ...
        <section id="section-29">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">29. Handling Time Promise</h2>
          <p>All orders are packed and dispatched within <strong className="text-[#0f0f0f]">2-3 business days</strong>. If delays occur due to stock or courier issues, customers will be notified via email or SMS.</p>
        </section>

        {/* 30. Community */}
        <section id="section-30">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-4">30. Community Contribution Clause</h2>
        ...
        {/* 31. Contact Us */}
        <section id="section-31" className="border-t border-zinc-200 pt-10">
          <h2 className="text-2xl font-bold text-[#0f0f0f] mb-6">31. Contact Us</h2>
          <div className="bg-white p-6 md:p-8 rounded-xl border border-zinc-200 shadow-sm">
            <p className="mb-6 text-zinc-600">To resolve a complaint regarding the Services or to receive further information regarding the use of the Services, please contact us at:</p>
            
            <div className="grid md:grid-cols-2 gap-8 text-sm">
              <div>
                <span className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-1">Legal Name</span>
                <span className="text-[#0f0f0f] font-bold text-base">Priyanka Ghosh</span>
              </div>
              <div>
                <span className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-1">Trade Name</span>
                <span className="text-[#0f0f0f] font-bold text-base">Noctowls</span>
              </div>
              <div className="md:col-span-2">
                <span className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-1">Address</span>
                <span className="text-[#0f0f0f] font-bold text-base leading-relaxed">2nd floor, Arushi complex, ITI Aambagan, Muchipara, Durgapur, West Bengal 713212, India</span>
              </div>
              <div>
                <span className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-1">Phone</span>
                <span className="text-[#0f0f0f] font-bold text-base">+91 83483 41112</span>
              </div>
              <div>
                <span className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-1">Email</span>
                <a href="mailto:help.noctowls@gmail.com" className="text-[#0f0f0f] font-bold hover:text-red-600 text-base transition-colors underline">help.noctowls@gmail.com</a>
              </div>
            </div>
          </div>
        </section>
