            ...
            <nav className="nav-icons flex gap-4 w-[30%] justify-end">
                ...
                }
                {
                    ...
                    <Link to="/bag" className='relative'>
                        ...
                        <span className={`${cart?.summary.totalQuantity === 0 ? "hidden" : "flex"} absolute -bottom-1 -right-1/3 w-4 aspect-square rounded-full bg-white justify-center items-center text-black text-[0.6rem] font-medium`}>
